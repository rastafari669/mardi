...
const continues_btn = info_box.querySelector('.buttons .restart');
...
next_btn.onclick = () =>{
   if(que_count < questions.length -1){
    ...
    startTimer(timeValue);
    clearInterval(counterLine);
       console.log("Qustions Completed");
       showResultBox();
   }
...
function showResultBox(){
    ...
    if(userScore > 3){
        let scoreTag ='<span>and congrads!, You got <p>'+ userScore +'</p> out of <p>'+ questions.length+'</p></span>';
